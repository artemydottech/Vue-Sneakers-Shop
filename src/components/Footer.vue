...
<template>
  <footer class="footer flex items-center bg-slate-400 p-10 h-20">
    <svg
    ...
    <!-- <img src="../../public/az.svg" alt="" /> -->
    <p class="text-white text-lg">the site was created by Artemy Zverev</p>
  </footer>
</template>
